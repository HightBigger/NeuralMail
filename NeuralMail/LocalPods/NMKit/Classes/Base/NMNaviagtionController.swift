...
open class NMNavigationController: UINavigationController {
    ...
    private func setupAppearance() {
        ...
        appearance.largeTitleTextAttributes = [
            ...
            .font: UIFont.systemFont(ofSize: 34, weight: .bold) // iOS 标准大标题样式
        ]
...
extension NMNavigationController: UIGestureRecognizerDelegate {
